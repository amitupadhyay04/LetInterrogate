...
void set6()
{
        ...
        system("color 0E");
        afans();
        cout << "Q 1.What is the boiling point temperature (water)?\n";
        cout << "a)50\nb)100\nc)150\nd)200\n";
        cout << "Enter option\n";
        ...
        ansb(a);
        afans();
        cout << "Q 2.Which fruit is associated with Isaac Newton?\n";
        cout << "a)Banana\nb)Apple\nc)Pear\nd)Pineapple\n";
        cout << "Enter option\n";
        ...
        ansb(a);
        afans();
        cout << "Q 3.What is the capital city of Australia?\n";
        cout << "a)Sydney\nb)Melbourne\nc)Canberra\nd)Brisbane\n";
        cout << "Enter option\n";
        ...
        ansa(a);
        afans();
        cout << "Q 4.The unit of current is \n";
        cout << "a)ohm\nb)watt\nc)ampere\nd)None of the above\n";
        cout << "Enter option\n";
        ...
        ansc(a);
        afans();
        cout << "Q 5.The telescope is used for viewing\n";
        cout << "a)distant objects\nb)near objects\nc)small objects\nd)living cells\n";
        cout << "Enter option\n";
...
void set7()
{
        ...
        system("color 0E");
        afans();
        cout << "Q 1. Which is the biggest Public Sector undertaking in the country?\n";
        cout << "a)Buses\nb) IT Sector\nc)Railways\nd)Banking Sector\n";
        cout << "Enter option\n";
        ...
        ansc(a);
        afans();
        cout << "Q 2.Due to bite of mad dog the disease hydrophobia is caused by which virus?\n";
        cout << "a)Dengue\nb)Chinkengunia\nc) Rabies virus\nd)Cancer\n";
        cout << "Enter option\n";
        ...
        ansc(a);
        afans();
        cout << "Q 3.Who appoints the Chief Election Commissioner of India?\n";
        cout << "a) Prime Minister\nb)Deputy Minister\nc)President \nd)Chief Minister\n";
        cout << "Enter option\n";

        cin >> a;
        ansc(a);
        afans();
        cout << "Q 4.Gobar gas contains mainly which gas?\n";
        cout << "a)Methane\nb)Hydrogen\nc)Oxygen\nd)Silicon\n";
        cout << "Enter option\n";
        ...
        ansa(a);
        afans();
        cout << "Q 5.A temperature at which both the Fahrenheit and the centigrade scales have the same value?\n";
        cout << "a) 10 degree\nb).20 degree\nc)-40 degree\nd)40 degree \n";
        cout << "Enter option\n";
...
void set11()
{
        ...
        system("color 0E");
        afans();
        cout << "Q 1. At which one place did Mahatma Gandhi first start his Satyagraha in India?\n";
        cout << "a)Bhuj\nb)Madras\nc)Champaran\nd)Guhawati\n";
        cout << "Enter option\n";
        ...
        ansc(a);
        afans();
        cout << "Q 2. India becomes the 4th country to test Anti-satellite missile system named\n";
        cout << "a) Mission Rohini\nb)Mission Bhaskara\nc)Mission Shakti\nd) Mission OceanSat\n";
        cout << "Enter option\n";

        cin >> a;
        ansc(a);
        afans();
        cout << "Q 3. According to the Skytrax World Airport Awards, which airport has been crowned the world's best aviation hub?\n";
        cout << "a)Incheon International Airport\nb)Singapore's Changi Airport\nc)Tokyo International Airport\nd) Indira Gandhi International Airport\n";
        cout << "Enter option\n";

        cin >> a;
        ansb(a);
        afans();
        cout << "Q 4.Which rocks is transformed into marble?\n";
        cout << "a)Limestone\nb)Black stone\nc)Red stone\nd)Grenite\n";
        cout << "Enter option\n";
        ...
        ansa(a);
        afans();
        cout << "Q 5.By which number the quality of gasoline sample is determined?\n";
        cout << "a)By its octane number \nb) Iodine Value\nc)Cetaine Number\nd)Mass density\n";
        cout << "Enter option\n";
...
void set12()
{
        ...
        system("color 0E");
        afans();
        cout << "Q 1. Fatehpur Sikri was founded as the capital of the Mughal Empire by\n";
        cout << "a)Jahangir\nb)Akbar\nc)Babur\nd)Humayun\n";
        cout << "Enter option\n";
        ...
        ansb(a);
        afans();
        cout << "Q 2.Which Veda depicts the information about the most ancient Vedic age culture?\n";
        cout << "a)Atharvaveda\nb)Samaveda\nc)Rig Veda\nd)Yajurveda\n";
        cout << "Enter option\n";
        ...
        ansc(a);
        afans();
        cout << "Q 3.  The Grand Canyon located in which country? \n";
        cout << "a)Ghana\nb)The US\nc)Canada\nd)Bolivia\n";
        cout << "Enter option\n";
        ...
        ansb(a);
        afans();
        cout << "Q 4. Which of the following is known as the Diamond City of India?\n";
        cout << "a)Mumbai\nb)Jaipur\nc)Surat\nd)Panna\n";
        cout << "Enter option\n";
        ...
        ansd(a);
        afans();
        cout << "Q 5.The famous Lucknow pact of 1916 was signed between\n";
        cout << "a)Mahatma Gandhi and Muhammad Ali Jinnah\nb)Bal Gangadhar Tilak and Aga Khan\nc)Mahatma Gandhi and Aga Khan\nd)Bal Gangadhar Tilak and Muhammad Ali Jinnah\n";
        cout << "Enter option\n";
